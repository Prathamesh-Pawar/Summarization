...
def main():
    ...
    bart_base_summary = get_chunks(dataset['test']['content'][0], summarizer)
    ...
    bart_custom_summary = get_chunks(dataset['test']['custom_approach'][0], summarizer)
    ...
    pegasus_base_summary = get_chunks(dataset['test']['content'][0], summarizer)
    rouge_score_generation(dataset['test']['summary'][0], pegasus_base_summary)
